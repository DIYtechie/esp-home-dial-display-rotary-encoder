...
static const uint32_t FASTEST_SPEED_THRESHOLD_MS = 190;
static const uint32_t FAST_SPEED_THRESHOLD_MS = 240;
static const uint32_t MEDIUM_SPEED_THRESHOLD_MS = 320;
static const uint32_t SLOW_MEDIUM_SPEED_THRESHOLD_MS = 450;
static const int32_t FASTEST_VALUE_STEP = 5;
static const int32_t FAST_VALUE_STEP = 4;
static const int32_t MEDIUM_VALUE_STEP = 3;
